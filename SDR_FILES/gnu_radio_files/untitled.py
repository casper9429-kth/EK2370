...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.uhd_usrp_sink_0.set_bandwidth(sample_rate, 0)
        ...
        self.filter_fft_low_pass_filter_0 = filter.fft_filter_ccc(1, firdes.low_pass(1, sample_rate, 1000, 200, window.WIN_HAMMING, 6.76), 1)
        self.dc_blocker_xx_0_0 = filter.dc_blocker_cc(32, True)
        self.dc_blocker_xx_0 = filter.dc_blocker_cc(32, True)
        self.blocks_wavfile_sink_0 = blocks.wavfile_sink(
            '/home/casper/repos/EK2370/SDR_FILES/gnu_radio_reccordings/sdr_iq_multi_target',
            1,
            sample_rate,
            blocks.FORMAT_WAV,
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(sample_rate, analog.GR_COS_WAVE, 4000, 1, 0, 0)


        ##################################################
        # Connections
        ##################################################
        self.connect((self.analog_sig_source_x_0, 0), (self.dc_blocker_xx_0_0, 0))
        ...
        self.connect((self.dc_blocker_xx_0, 0), (self.blocks_multiply_conjugate_cc_0, 0))
        self.connect((self.dc_blocker_xx_0_0, 0), (self.blocks_multiply_conjugate_cc_0, 1))
    ...
    def get_sinus_freq(self):
        return self.sinus_freq

    def set_sinus_freq(self, sinus_freq):
    ...
    def set_sample_rate(self, sample_rate):
        ...
        self.filter_fft_low_pass_filter_0.set_taps(firdes.low_pass(1, self.sample_rate, 1000, 200, window.WIN_HAMMING, 6.76))
        self.uhd_usrp_sink_0.set_samp_rate(self.sample_rate)
        self.uhd_usrp_sink_0.set_bandwidth(self.sample_rate, 0)
